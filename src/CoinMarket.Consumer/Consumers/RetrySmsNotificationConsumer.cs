...
public class RetrySmsNotificationConsumer : BackgroundService
{
    private readonly IServiceProvider _sp;
    private readonly IModel _channel;
    private const string QueueName = "retry-buyorder-sms-created";

    public RetrySmsNotificationConsumer(ConnectionFactory connectionFactory, IServiceProvider sp)
    {
        _sp = sp;
